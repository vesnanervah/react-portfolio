...
export default function ScrollDown() {
    return <button onClick={() => {/*TODO: navigate to the last app section*/}} className={"flex align-middle text-white fill-white transition-colors duration-200 hover:text-red-600 hover:fill-rose-600 cursor-pointer " + `${mulish.className}`}>
        Scroll down
